 ...
 * ```
 */
export declare const getAssetPairTickerOriginal: <TKeys extends string>(...pairs: TKeys[]) => Promise<{
    error: string[];
 ...
 * ```
 */
export declare const getAssetPairTicker: (pair: string) => Promise<import("./response-types").ObjectTickerResponse>;
/**
 ...
 * ```
 */
export declare const getAssetPairsTicker: <TKeys extends string>(...pairs: TKeys[]) => Promise<{ [key in TKeys]: import("./response-types").ObjectTickerResponse; }>;
